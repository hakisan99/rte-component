...
const Icon = ({icon}) => {
    const Ico = icon === "bold" ?
        ...
        icon === 'heading 3' ? 
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-type-h3" viewBox="0 0 16 16">
        ...
        icon === 'increase-indentation' ?
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-text-indent-left" viewBox="0 0 16 16">
