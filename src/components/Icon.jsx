...
const Icon = ({icon, isDisabled, color}) => {
    const Ico =
      icon === 'bold' ? (
        ...
        <svg xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 0 48 48" width="20" fill="currentColor">
          <path d="M0 0h48v48h-48z" fill="none" />
          <path xmlns="http://www.w3.org/2000/svg" d="M0 40h48v8h-48z" fillOpacity="0.8" fill={color ? color : "currentColor"}/>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 0 48 48" width="20" fill="currentColor">
          ...
          <path d="M0 40h48v8h-48z" fillOpacity=".8" fill={color ? color : "currentColor"}/>
        </svg>
      ) : (
        <p>X</p>
      );
